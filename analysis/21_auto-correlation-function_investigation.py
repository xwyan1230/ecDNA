...
plt.subplots(figsize=(6, 4))
plt.plot(r[:60], g[:60], color='#FFD700', label='100 dots R50')
plt.plot(r1[:60], g1[:60], alpha=0.4, color='#40E0D0', label='100 dots R35')
plt.plot(r2[:60], g2[:60], alpha=0.4, color='#DA70D6', label='100 dots R20')
#plt.ylim([-0.5, 5])
plt.xlabel('r')
plt.ylabel('g')
plt.legend(loc=2, bbox_to_anchor=(0.02, 0.99))
